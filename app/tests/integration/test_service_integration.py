...
class TestTokenService:
    ...
    async def test_create_pair_tokens(
        self, get_uow: UOWContextProtocol, token_service: ABCTokenService, current_user: ResponseUserSchema
    ):
    ...
    async def test_raise_refresh_pair_tokens(self, get_uow: UOWContextProtocol, token_service: ABCTokenService):
        assert self.tokens
